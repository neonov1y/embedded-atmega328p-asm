...
Example (Arduino Uno / Atmaga328p):</ br>
...
=============================================
Enter minicom setting menu:</ br>
```$ sudo minicom -s```

Run minicom with specific boud rate (also supports boud rates that not available in settings menu):</ br>
```$ sudo minicom -b <boud_rate>```
Examples of boud rates: 9600, 115200, 500000

Display characters in hex format:</ br>
```$ sudo minicom -H```

Store received data to file:</ br>
